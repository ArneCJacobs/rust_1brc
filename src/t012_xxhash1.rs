use std::{collections::HashMap, hash::BuildHasherDefault, ops::BitXor};
...
type HashMapXx<K, V> = HashMap<K, V, BuildHasherDefault<XxHash64>>;
#[inline]
pub fn one_brc(file: &str) -> String {
    let mut measurements: HashMapXx<&str, Measurement> = HashMapXx::default();
